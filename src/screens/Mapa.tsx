...
type PinKind = 'pickup' | 'farm';

function MapPin({
  top, left, color, kind, active = false,
}: { top: number; left: number; color: string; kind: PinKind; active?: boolean }) {
  return (
    <div style={{
  ...
  return (
    <IOSDevice width={390} height={844}>
      ...
      <div style={{ position: 'absolute', top: 54, left: 16, right: 16, zIndex: 10 }}>
        ...
        <div className="noscroll" style={{ display: 'flex', gap: 6, marginTop: 10, overflowX: 'auto' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 12 }}>
          {([['1.8 mi', 'distancia'], ['Sáb', '8–11am'], ['18', 'fincas']] as [string, string][]).map(([v, u], i) => (
            <div key={i} style={{
