...
export function IOSNavBar({
  title = 'Title', dark = false, trailingIcon = true,
}: { title?: string; dark?: boolean; trailingIcon?: boolean }) {
...
export function IOSList({
  header, children, dark = false,
}: { header?: ReactNode; children: ReactNode; dark?: boolean }) {
...
export function IOSKeyboard({ dark = false }: { dark?: boolean }) {
  ...
  type KeyOpts = { w?: number; flex?: boolean; ret?: boolean; fs?: number; k?: string };
